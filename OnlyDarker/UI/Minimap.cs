...
namespace OnlyDarker.UI
{
    public class Minimap
    {
        ...
        private void DrawFrame()
        {
            ...
            GlobalUse.SpriteBatch.Draw(_minimapFrame, Bounds, Color.White);
        ...
        private void DrawIcons()
        {
            ...
            {
                int i = (int)room.InstanceRoomType;
            ...
            GlobalUse.SpriteBatch.Draw(_minimapIcons[^1], new Vector2(CurrentRoom.GridCords.X * _minimapIcons[^1].Width, CurrentRoom.GridCords.Y * _minimapIcons[^1].Height), Color.White);
            GlobalUse.SpriteBatch.End();
        }

        public static List<Texture2D> LoadMinimapIcons()
        {
